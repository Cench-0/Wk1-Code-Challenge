...
function NetSalary(basicSalary, benefits) {
    ...
    if (monthlyTaxableIncome <= 24000) {
      ...
      paye = 147,500 + (monthlyTaxableIncome - 500000) * 0.325;
    } else {
      paye = 230,000 + (monthlyTaxableIncome - 800000) * 0.35;
    }
  ...
  // const result = NetSalary(50000, 5000);
  const result1 = NetSalary(100000, 10000)
console.log(result1);